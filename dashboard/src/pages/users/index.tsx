...
function createData(id: number, name: string, surname: string, email: string, phoneNumber: string, role: string): Data {
    return {
        id,
        name,
        surname,
...
function EnhancedTableToolbar(props: EnhancedTableToolbarProps) {
    ...
    return (
        ...
        >
            ...
            <Button onClick={RedirectRegister} variant="contained"><Link style={{ textDecoration: "none", color: "#fff" }} to={"/dashboard/sign-up"}>Add User</Link></Button>
...
const Users: React.FC = () => {
    ...
    if (isRedirect) {
        <Navigate to={"/dashboard/editUser"}></Navigate>
    }
                                ...
                                .map((row, index) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            {user.role === "Administrators" && <TableCell align="left"><Button
                                                variant="outlined"
